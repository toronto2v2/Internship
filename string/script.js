...
__________________________________________________________________________________________
|                                                                                        |
|   String.prototype.startsWith(str, end)       String.prototype.endsWith(str, end)      |
|________________________________________________________________________________________| */
let startsWith
let endsWith
...
__________________________________________________________________________________________
|                                                                                        |
|                              String.prototype.includes(substr, from)                   |
|________________________________________________________________________________________| */
let includes
...
__________________________________________________________________________________________
|                                                                                        |
|                              String.prototype.indexOf(substr, from)                    |
|________________________________________________________________________________________| */
let indexOf
...
__________________________________________________________________________________________
|                                                                                        |
|                           String.prototype.lastIndexOf(substr, from)                   |
|________________________________________________________________________________________| */
let lastIndexOf
// приймає два параметри: 1. рядок який шукаєм 2. з якої позиції починаєм
...
__________________________________________________________________________________________
|                                                                                        |
|                               String.prototype.match(regex|str)                        |
|________________________________________________________________________________________| */
let match
...
__________________________________________________________________________________________
|                                                                                        |
|                            String.prototype.matchAll(regex|str)                        |
|________________________________________________________________________________________| */
let matchAll
...
__________________________________________________________________________________________
|                                                                                        |
|                            String.prototype.normalize(param)                           |
|________________________________________________________________________________________| */
let normalize
...
__________________________________________________________________________________________
|                                                                                        |
|                     String.prototype.padEnd(targetLength, whatToAdd)                   |
|________________________________________________________________________________________| */
let padEnd
...
__________________________________________________________________________________________
|                                                                                        |
|             String.prototype.padStart(targetLength, whatToAdd)                         |
|________________________________________________________________________________________| */
let padStart
...
__________________________________________________________________________________________
|                                                                                        |
|                              String.prototype.repeat(howManyTimes)                     |
|________________________________________________________________________________________| */
let repeat
...
__________________________________________________________________________________________
|                                                                                        |
|                      String.prototype.replace(regex|str, func|str)                     |
|________________________________________________________________________________________| */
let replace
...
'The Quick Brown Fox Jumps over the lazy dog'.replace(/([A-Z])/g, (match, p1 ,offset, str) => `-${p1.toLowerCase()}`);// "-the -quick -brown -fox -jumps over the lazy dog"



// Також другим аргументом можна передати рядок в якому можна використовувати спеціальні символи:

//      $$  ====>   вставляє символ долара $
//      $&  ====>   вставляє рядок, який співпав з регуляркою
//      $`  ====>   вставляє рядок, який йшов перед рядком зпівпавшим з регуляркою
//      $'  ====>   вставляє рядок, який йшов після рядку зпівпавшим з регуляркою
//      $n  ====>   вставляє n-нну зпівпавшу підгруппу
...
__________________________________________________________________________________________
|                                                                                        |
|                       String.prototype.replaceAll(regex|str,  func|str)                |
|________________________________________________________________________________________| */
let replaceAll
/* Метод String.prototype.replace() використовується для заміни підрядка в рядку на інший підрядок.
Він приймає два аргументи: перший аргумент - це підрядок, який необхідно замінити, 
...
__________________________________________________________________________________________
|                                                                                        |
|                                String.prototype.search(regex|str)                      |
|________________________________________________________________________________________| */
...
__________________________________________________________________________________________
|                                                                                        |
|                                String.prototype.split(str|regex)                       |
|________________________________________________________________________________________| */
let split
