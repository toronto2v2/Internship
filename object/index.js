...
// внаслідувані та неперечисляємі властивості не копіюються
...
let map
// map це структура данних, яка збрерігає пари ключ/значення, і памятає порядох їх додавання.
// В якості ключів можуть використовуватись будь які значення.

/* Переваги:
=== будь який тип ключу
=== безпечній в використанні при наданні ключів і значень юзером
