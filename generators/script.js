...
modifyYieldInstanced.next();   //{ value: 1, done: false }
modifyYieldInstanced.next(3);  //{ value: 8, done: false } - аргумент з next, записав в змінну а генератору modifyYield число 5
modifyYieldInstanced.next(2);  //{ value: 5, done: false }- аргумент з next, записав в змінну b генератору modifyYield число 2
modifyYieldInstanced.next(5);  //{ value: undefined, done: true }